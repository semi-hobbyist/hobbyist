...
@WebServlet("/admin/adminOnedayList")
public class AdminOnedayListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AdminOnedayListServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 페이징처리
				...
				if(pageNo==1) {
					...
					pageBar += "<a href='" + request.getContextPath() + "/admin/adminOnedayList?cPage=" + (pageNo-1) + "&numPerPage=" + numPerPage + "'>이전</a>";
				}
				...
				while(!(pageNo>totalPage || pageNo>pageEnd)) {
					if(pageNo==cPage) {
						...
						pageBar += "<a href='" + request.getContextPath() + "/admin/adminOnedayList?cPage=" + pageNo + "&numPerPage=" + numPerPage + "'>" + pageNo + "</a>";
					}
					pageNo++;
				}
				...
				if(pageNo>totalPage) {
					...
					pageBar += "<a href='" + request.getContextPath() + "/admin/adminOnedayList?cPage=" + pageNo + "&numPerPage=" + numPerPage + "'>다음</a>"; 
				}
				...
				request.getRequestDispatcher("/views/admin/oneday/adminOnedayList.jsp").forward(request, response);
	}
