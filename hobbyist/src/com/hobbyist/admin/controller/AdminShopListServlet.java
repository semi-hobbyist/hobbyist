...
@WebServlet("/admin/adminShopList")
public class AdminShopListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AdminShopListServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 페이징처리
				...
				if(pageNo==1) {
					...
					pageBar += "<a href='" + request.getContextPath() + "/admin/adminShopList?cPage=" + (pageNo-1) + "&numPerPage=" + numPerPage + "'>이전</a>";
				}
				...
				while(!(pageNo>totalPage || pageNo>pageEnd)) {
					if(pageNo==cPage) {
						...
						pageBar += "<a href='" + request.getContextPath() + "/admin/adminShopList?cPage=" + pageNo + "&numPerPage=" + numPerPage + "'>" + pageNo + "</a>";
					}
					pageNo++;
				}
				...
				if(pageNo>totalPage) {
					...
					pageBar += "<a href='" + request.getContextPath() + "/admin/adminShopList?cPage=" + pageNo + "&numPerPage=" + numPerPage + "'>다음</a>"; 
				}
				...
				request.getRequestDispatcher("/views/admin/shop/adminShopList.jsp").forward(request, response);
	}
