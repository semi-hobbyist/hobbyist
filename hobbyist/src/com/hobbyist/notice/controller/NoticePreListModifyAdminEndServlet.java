...
/**
 * Servlet implementation class NoticePreListModifyAdminEndServlet
 */
@WebServlet("/notice/noticePreListModifyAdminEnd")
public class NoticePreListModifyAdminEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticePreListModifyAdminEndServlet() {
        super();
