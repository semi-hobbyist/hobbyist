...
@WebServlet("/oneday/onedayReviewListAjax")
public class OnedayReviewListAjaxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public OnedayReviewListAjaxServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Review> list = new OnedayService().reviewList(review_class, rPage, rPerPage);
