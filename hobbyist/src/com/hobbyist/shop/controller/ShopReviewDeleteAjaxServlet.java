...
@WebServlet("/shop/shopReviewDeleteAjax")
public class ShopReviewDeleteAjaxServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ShopReviewDeleteAjaxServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("no : " + no + " rc : " + review_class);
		
		int result = new ShopService().reviewDelete(no);
