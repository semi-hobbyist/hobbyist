...
@WebServlet("/shop/shopWrite")
public class ShopWriteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ShopWriteServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/views/shop/shopWrite.jsp").forward(request, response);
	}
