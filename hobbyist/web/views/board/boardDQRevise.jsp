...
<div class="board_content">
	...
	<div id="board_right">
		...
		<div class="board_middle">
			<h2>자유게시판 등록</h2>
	<form action="<%=request.getContextPath()%>/board/boardDQReviseEnd?boardDQNo=<%=b.getBoardDQNo()%>" method="post" enctype="multipart/form-data">
	
		<table id="tbl_write">
			<tr>
				<th>제목</th>
				<td><input type="text" name="title" id="title" value="<%=b.getBoardDQTitle()%>" required/></td>
			</tr>
			<tr>
				<th>작성자</th>
				<td><input type="text" name="writer"
				value='<%=logginMember.getMemberNickname()%>' style="width: 80px;" value="<%=b.getBoardDQWriter()%>" readonly/></td>
			</tr>
			<tr>
				<th>첨부파일</th>
				<td>
					<input type="file" name="up_file" value="<%=b.getBoardDQReNameFileName()%>"/>
				</td>
			</tr>
			<tr>
				<th>내용</th>
				<td><textarea name="content" id="editor1"><%=b.getBoardDQContent()%></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
