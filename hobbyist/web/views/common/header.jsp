            ...
            <div class="sub" id="menuAll">
                <div class="sub_content">
                    <ul>
                        ...
                        <li class="all_li">
                            <ul>
                                <li onclick="location.href='<%= request.getContextPath()%>/notice/noticeList'">공지사항/이벤트
                                </li>
                            </ul>
                        </li>
                        <li class="all_li">
                            <ul>
                                ...
                                <li
                                    onclick="location.href='<%=request.getContextPath() %>/shop/shopCateList?cate=가죽공예'">
                                    가죽공예</li>
                                <li onclick="location.href='<%=request.getContextPath() %>/shop/shopCateList?cate=위빙'">
                                    위빙</li>
                                <li onclick="location.href='<%=request.getContextPath() %>/shop/shopCateList?cate=수채화'">
                                    수채화</li>
                                <li
                                    onclick="location.href='<%=request.getContextPath() %>/shop/shopCateList?cate=마크라메'">
                                    마크라메</li>
                                <li onclick="location.href='<%=request.getContextPath() %>/shop/shopCateList?cate=뜨개질'">
                                    뜨개질</li>
                                <li
                                    onclick="location.href='<%=request.getContextPath() %>/shop/shopCateList?cate=프랑스자수'">
                                    프랑스자수</li>
                            </ul>
                        </li>
                        <li class="all_li">
                            <ul>
                                ...
                                <li
                                    onclick="location.href='<%=request.getContextPath() %>/oneday/onedayCateList?cate=서울'">
                                    서울지역</li>
                                <li
                                    onclick="location.href='<%=request.getContextPath() %>/oneday/onedayCateList?cate=경기'">
                                    경기지역</li>
                            </ul>
                        </li>
                        <li class="all_li">
