...
<body>
    ...
    <header>
        <div id="header-top">
          <div class="left-top">
                <a href="<%= request.getContextPath() %>/writer/writerEnroll">[작가모집] 새로운 하비스트 작가님을 모십니다</a><div id="line"></div>
           </div>
            <div class="top">
                <ul>
        ...
        <div id="header-middle">
            <div class="middle">
                <div class="logo">
                    <a href="<%= request.getContextPath() %>"><img alt="하비스트" src="<%= request.getContextPath() %>/images/logo.png"></a>
                </div>
                <div class="search">
                    <input type="search" placeholder="Search..." /><input type="button" value="검색" />
                </div>
                <div class="info">
                    <img src="<%= request.getContextPath() %>/images/myclass.png" id="icon_myclass" width="26px" onclick="fn_myclass()" style="cursor:pointer;">&nbsp;&nbsp;&nbsp;&nbsp;
                    <img src="<%= request.getContextPath() %>/images/cart.png" id="icon_cart" width="24px" onclick="fn_cart()" style="cursor:pointer;"><span id="cartCount"></span>
                    <br><div id="icon_sub"></div>
                </div>
                <script>
                $.ajax({
