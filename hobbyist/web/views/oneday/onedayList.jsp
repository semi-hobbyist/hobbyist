<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*, com.hobbyist.oneday.model.vo.Oneday, com.hobbyist.oneday.model.vo.Review, com.hobbyist.oneday.model.vo.Cate" %>

<%	
	List<Cate> cate = (List)request.getAttribute("Cate");
					...
					<script>
						...
						function fn_sortBtn(e) {
							if(e.innerText=='최근등록순') {
								...
								$('#sort').val('descEnroll');
								$.ajax({
									url: '<%= request.getContextPath() %>/oneday/onedayListAjax',
									type: 'POST',
									dataType: 'text',
