...
<section id="onedayWrite">
	<div class="onedayWrite_content">
		<div class="onedayWrite_left">
			<ul>
				<h3>CLASS<br>ADMINISTRATOR</h3>
				<li onclick="location.href='<%= request.getContextPath() %>/oneday/onedayList';">← 목록으로</li>
				<li id="sub1" onclick="location.href='#';">원데이클래스 목록</li>
				<li id="sub1" onclick="location.href='#';">원데이클래스 등록</li>
			</ul>
		</div>
		<div class="onedayWrite_right">
			...
			<table>
				<tr>
					...
					<td id="cate">
						...
						<script>
							function newCate() {
								$('#cate').append("<form action='<%= request.getContextPath() %>/oneday/onedayCateInsert' method='POST'><input type='text' name='newCate' placeholder='카테고리 명'/><input type='submit' value='생성'/></form>");
							}
						</script>
					</td>
				</tr>
				...
				<tr>
					<th>클래스 선택옵션 2</th>
					<td><input type="text" name="class_option2"/></td>
				</tr>
				<tr>
					<th>클래스 선택옵션 3</th>
					<td><input type="text" name="class_option3"/></td>
				</tr>
				<tr>
					<th>클래스 선택옵션 4</th>
					<td><input type="text" name="class_option4"/></td>
				</tr>
				<tr>
					<th>클래스 선택옵션 5</th>
					<td><input type="text" name="class_option5"/></td>
				</tr>
				<tr>
					<th>이미지1</th>
