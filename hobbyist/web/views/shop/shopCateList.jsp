					...
					<script>
						...
						function fn_sortBtn(e) {
							...
							if(e.innerText=='최근등록순') {
								...
								$('#sort').val('descEnroll');
								$.ajax({
									url: '<%= request.getContextPath() %>/shop/shopCateListAjax',
									type: 'POST',
									dataType: 'text',
		...
		<script>
			function fn_ListAjax(pageNo) {
				...
				if(text=='최근등록순') {
					$.ajax({
						url: '<%= request.getContextPath() %>/shop/shopCateListAjax',
						data : 'cate=' + cateData + 'sort=descEnroll&cPage=' + pageNo,
						success: function (data) {
							var shopAjax = $('#shop-ajax');
							shopAjax.empty();
							shopAjax.html(data);
					...
					$.ajax({
						url: '<%= request.getContextPath() %>/shop/shopCateListAjax',
						data : 'cate=' + cateData + 'sort=ascPrice&cPage=' + pageNo,
						success: function (data) {
							var shopAjax = $('#shop-ajax');
							shopAjax.empty();
							shopAjax.html(data);
					...
					$.ajax({
						url: '<%= request.getContextPath() %>/shop/shopCateListAjax',
						data : 'cate=' + cateData + 'sort=descPrice&cPage=' + pageNo,
						success: function (data) {
							var shopAjax = $('#shop-ajax');
							shopAjax.empty();
							shopAjax.html(data);
